...
class MainPortScannerWindow(QWidget):
    def __init__(self):
        ...
        self.ip_address.setStyleSheet("border:1px solid #0650af;border-radius:5px;padding:10px;")
        ...
        self.first_range.setStyleSheet("border:1px solid #0650af;border-radius:5px;padding:10px;")
        ...
        self.second_range.setStyleSheet("border:1px solid #0650af;border-radius:5px;padding:10px;")
